...
! source statement 10
	...
	st	%g0,[%o1 + %o2]     ! sets=        uses=%g0:%o1:%o2:deads=%o1:%o2:
!ABOVE
	add	%l0,1,%l0	          ! sets=%l0:    uses=%l0:     deads=%l0:
! source statement 10
!ABOVE
	cmp	%l0,16	             ! sets=        uses=%l0:     deads=
! source statement 10
...
! source statement 24
	...
	sethi	%hi(x),%o2          ! sets=%o2:    uses=         deads=
	add	%o2,%lo(x),%o2      ! sets=%o2:    uses=%o2:     deads=%o2:
	st	%l0,[%o1 + %o2]     ! sets=        uses=%o1:%o2:%l0:deads=%o1:%o2:
!ABOVE
...
! source statement 39
	...
	ld	[%l1 + %o2],%o1     ! sets=%o1:    uses=%o2:%l1: deads=%o2:
