...
! .1_space = %o5
	mov	%i3,%o5             ! sets=%o5:    uses=%i3:     deads=
! source statement 122
	mov	%i3,%g2             ! sets=%g2:    uses=%i3:     deads=%i3:
! source statement 123
	mov	%g0,%g4             ! sets=%g4:    uses=%g0:     deads=
	sethi	%hi(btab),%l1       ! sets=%l1:    uses=         deads=
	add	%l1,%lo(btab),%l0   ! sets=%l0:    uses=%l1:     deads=%l1:
!
! block 2
! preds: 1 20
! succs: 16
!  doms: 1 2
!   ins=%g2:%g4:%g7:%o3:%o4:%o5:%l0:
!  outs=%g1:%g2:%g4:%g5:%g7:%o3:%o4:%o5:%l0:%l2:
!
.L89:
! source statement 124
	mov	%g0,%g5             ! sets=%g5:    uses=%g0:     deads=
! source statement 125
	mov	%g7,%g1             ! sets=%g1:    uses=%g7:     deads=
	ba	.L92                ! sets=        uses=         deads=
...
! succs: 4 5
!  doms: 1 2 3 16 17
!   ins=%g1:%g2:%g4:%g5:%g7:%o3:%o4:%o5:%l0:%l2:
!  outs=%g1:%g2:%g3:%g4:%g5:%g7:%o3:%o4:%o5:%l0:%l2:
!
.L93:
! source statement 126
	mov	%g1,%o0             ! sets=%o0:    uses=%g1:     deads=
	add	%g1,1,%o1           ! sets=%o1:    uses=%g1:     deads=%g1:
...
!  doms: 1 2 3 4 16 17
!   ins=%g1:%g2:%g4:%g5:%g7:%o3:%o4:%o5:%l0:%l2:
!  outs=%g1:%g2:%g4:%g5:%g7:%o0:%o3:%o4:%o5:%l0:%l2:
!
...
! succs: 6
!  doms: 1 2 3 5 16 17
!   ins=%g1:%g2:%g3:%g4:%g5:%g7:%o3:%o4:%o5:%l0:%l2:
!  outs=%g1:%g2:%g4:%g5:%g7:%o0:%o3:%o4:%o5:%l0:%l2:
!
.L94:
	smul	%g3,7,%o0           ! sets=%o0:    uses=%g3:     deads=%g3:
	add	%o0,%l2,%o0         ! sets=%o0:    uses=%o0:%l2: deads=%o0:
	ldsb	[%o0 + %g4],%o0     ! sets=%o0:    uses=%g4:%o0: deads=%o0:
!
! block 6
! preds: 4 5
! succs: 14
!  doms: 1 2 3 6 16 17
!   ins=%g1:%g2:%g4:%g5:%g7:%o0:%o3:%o4:%o5:%l0:%l2:
!  outs=%g1:%g2:%g3:%g4:%g5:%g6:%g7:%o3:%o4:%o5:%l0:%l2:
!
.L95:
	mov	%o0,%g3             ! sets=%g3:    uses=%o0:     deads=%o0:
! source statement 127
	ba	.L98                ! sets=        uses=         deads=
	mov	64,%g6              ! sets=%g6:    uses=         deads=
!
! block 7
! preds: 14
! succs: 8 12
!  doms: 1 2 3 6 7 14 16 17
!   ins=%g1:%g2:%g3:%g4:%g5:%g6:%g7:%o3:%o4:%o5:%l0:%l2:
!  outs=%g1:%g2:%g3:%g4:%g5:%g6:%g7:%o3:%o4:%o5:%l0:%l2:
!
.L99:
! source statement 128
	andcc	%g6,%g3,%g0         ! sets=%g0:    uses=%g3:%g6: deads=
...
!  outs=%g1:%g2:%g3:%g4:%g5:%g6:%g7:%o3:%o4:%o5:%l0:%l2:
!
	cmp	%o3,%g0             ! sets=        uses=%g0:%o3: deads=
...
!   ins=%g1:%g2:%g3:%g4:%g5:%g6:%g7:%o3:%o4:%o5:%l0:%l2:
!  outs=%g1:%g2:%g3:%g4:%g5:%g6:%g7:%o0:%o3:%o4:%o5:%l0:%l2:
!
	ba	.L101               ! sets=        uses=         deads=
...
!
.L102:
	ldsb	[%g1 + (-1)],%o0    ! sets=%o0:    uses=%g1:     deads=
!
! block 11
! preds: 10
! succs: 13
!  doms: 1 2 3 6 7 8 10 11 14 16 17
!   ins=%g1:%g2:%g3:%g4:%g5:%g6:%g7:%o0:%o3:%o4:%o5:%l0:%l2:
!  outs=%g1:%g2:%g3:%g4:%g5:%g6:%g7:%o0:%o3:%o4:%o5:%l0:%l2:
!
.L103:
...
!
.L101:
	mov	%g2,%o1             ! sets=%o1:    uses=%g2:     deads=
	add	%g2,1,%o2           ! sets=%o2:    uses=%g2:     deads=%g2:
	mov	%o2,%g2             ! sets=%g2:    uses=%o2:     deads=%o2:
	stb	%o0,[%o1]           ! sets=        uses=%o0:%o1: deads=%o0:%o1:
! source statement 129
	andn	%g3,%g6,%o0         ! sets=%o0:    uses=%g3:%g6: deads=%g3:
	mov	%o0,%g3             ! sets=%g3:    uses=%o0:     deads=%o0:
! source statement 130
	sra	%g6,1,%o0           ! sets=%o0:    uses=%g6:     deads=%g6:
...
.L98:
! source statement 130
	cmp	%g3,%g0             ! sets=        uses=%g0:%g3: deads=
...
! source statement 132
	add	%g5,1,%o0           ! sets=%o0:    uses=%g5:     deads=%g5:
...
.L92:
! source statement 132
	ldsb	[%g1],%o0           ! sets=%o0:    uses=%g1:     deads=
	cmp	%o0,%g0             ! sets=        uses=%g0:%o0: deads=%o0:
...
!  outs=%g1:%g2:%g4:%g5:%g7:%o3:%o4:%o5:%l0:%l2:
!
	cmp	%g5,%o4             ! sets=        uses=%g5:%o4: deads=
...
! source statement 133
	sub	%g2,1,%o0           ! sets=%o0:    uses=%g2:     deads=%g2:
...
! source statement 135
	add	%g2,1,%o0           ! sets=%o0:    uses=%g2:     deads=%g2:
...
! source statement 137
	add	%g4,1,%o0           ! sets=%o0:    uses=%g4:     deads=%g4:
! source statement 137
	cmp	%o0,7               ! sets=        uses=%o0:     deads=%o0:
	bl	.L89                ! sets=        uses=         deads=
	mov	%o0,%g4             ! sets=%g4:    uses=%o0:     deads=
!
! block 21
! preds: 20
! succs:
...
! source statement 138
	stb	%g0,[%g2]           ! sets=        uses=%g0:%g2: deads=%g2:
...
! source statement 151
	mov	42,%l1              ! sets=%l1:    uses=         deads=
! source statement 152
	mov	10,%l3              ! sets=%l3:    uses=         deads=
!
! block 2
! preds: 1 4 7 11
! succs: 3 12
...
! source statement 153
	add	%l5,4,%o0           ! sets=%o0:    uses=%l5:     deads=%l5:
...
! source statement 154
	sub	%l4,1,%l4           ! sets=%l4:    uses=%l4:     deads=%l4:
! source statement 155
	ld	[%l5],%o1           ! sets=%o1:    uses=%l5:     deads=
	add	%o1,1,%o1           ! sets=%o1:    uses=%o1:     deads=%o1:
	st	%o1,[%l5]           ! sets=        uses=%o1:%l5: deads=
	ba	.L116               ! sets=        uses=         deads=
...
!
	ba	.L113               ! sets=        uses=         deads=
	sra	%o0,3,%l3           ! sets=%l3:    uses=%o0:     deads=
!
! block 8
! preds: 3
! succs: 9 4
...
! source statement 167
	...
	sll	%l3,6,%o0           ! sets=%o0:    uses=%l3:     deads=
!
! block 13
! preds: 12
! succs: 14
...
! source statement 169
	sub	%l4,1,%o0           ! sets=%o0:    uses=%l4:     deads=%l4:
	cmp	%o0,%g0             ! sets=        uses=%g0:%o0: deads=%o0:
...
! source statement 171
	...
	add	%l5,4,%o1           ! sets=%o1:    uses=%l5:     deads=%l5:
...
!   ins=%l1:%l2:%l3:
!  outs=%l1:%l2:%l3:%l4:%l7:%i0:
!
.L122:
	sethi	%hi(.L130),%l4      ! sets=%l4:    uses=         deads=
	sethi	%hi(.L111),%l5      ! sets=%l5:    uses=         deads=
	sethi	%hi(_iob),%l6       ! sets=%l6:    uses=         deads=
	add	%l5,%lo(.L111),%l7  ! sets=%l7:    uses=%l5:     deads=%l5:
	add	%l6,%lo(_iob),%i0   ! sets=%i0:    uses=%l6:     deads=%l6:
!
! block 20
! preds: 19 24
! succs: 21
!  doms: 1 2 12 13 14 19 20
!   ins=%l1:%l2:%l3:%l4:%l7:%i0:
!  outs=%o0:%l1:%l2:%l3:%l4:%l7:%i0:
!
.L128:
! source statement 176
	mov	%l7,%o0             ! sets=%o0:    uses=%l7:     deads=
...
!   ins=%l1:%l2:%l3:%l4:%l7:%i0:
!  outs=%o0:%l0:%l1:%l2:%l3:%l4:%l7:%i0:
!
! source statement 177
	mov	%l4,%l0             ! sets=%l0:    uses=%l4:     deads=
	mov	%l7,%o0             ! sets=%o0:    uses=%l7:     deads=
	mov	%l1,%o1             ! sets=%o1:    uses=%l1:     deads=
	mov	%l3,%o2             ! sets=%o2:    uses=%l3:     deads=
	call	mkline,4            ! sets=scratch uses=%o0:%o1:%o2:%o3:deads=
...
! source statement 187
	ldsb	[%g3 + %g1],%o0     ! sets=%o0:    uses=%g1:%g3: deads=
...
! source statement 188
	smul	%g2,10,%o0          ! sets=%o0:    uses=%g2:     deads=%g2:
! source statement 189
	mov	%g1,%o2             ! sets=%o2:    uses=%g1:     deads=
	add	%g1,1,%o3           ! sets=%o3:    uses=%g1:     deads=%g1:
	mov	%o3,%g1             ! sets=%g1:    uses=%o3:     deads=%o3:
	ldsb	[%g3 + %o2],%o1     ! sets=%o1:    uses=%g3:%o2: deads=%o2:
	sub	%o1,48,%o1          ! sets=%o1:    uses=%o1:     deads=%o1:
	add	%o0,%o1,%o0         ! sets=%o0:    uses=%o0:%o1: deads=%o0:%o1:
	ba	.L133               ! sets=        uses=         deads=
	mov	%o0,%g2             ! sets=%g2:    uses=%o0:     deads=
!
! block 5
! preds: 2 3
