...
! source statement 129
	andn	%g3,%g6,%g3         ! sets=%g3:    uses=%g3:%g6: deads=%g3:
...
!  outs=%l1:%l3:%l4:%l5:
!
	sra	%o0,3,%l3           ! sets=%l3:    uses=%o0:     deads=%o0:
	ba,a	.L113               ! sets=        uses=         deads=
!
! block 8
! preds: 3
...
! source statement 188
	smul	%g2,10,%g2          ! sets=%g2:    uses=%g2:     deads=%g2:
! source statement 189
	...
	add	%g2,%o1,%o0         ! sets=%o0:    uses=%g2:%o1: deads=%g2:%o1:
	mov	%o0,%g2             ! sets=%g2:    uses=%o0:     deads=%o0:
