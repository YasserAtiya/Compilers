...
! source statement 40
	...
	add	%l2,4,%g1           ! sets=%g1:    uses=%l2:     deads=
...
!
.L118:
	ld	[%g1],%o1           ! sets=%o1:    uses=%g1:     deads=
	add	%o1,1,%o2           ! sets=%o2:    uses=%o1:     deads=
	st	%o2,[%g1]           ! sets=        uses=%g1:%o2: deads=%o2:
