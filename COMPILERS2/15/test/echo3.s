...
! source statement 16
	...
	sethi	%hi(_iob),%g1       ! sets=%g1:    uses=         deads=
	add	%g1,%lo(_iob),%g6   ! sets=%g6:    uses=%g1:     deads=%g1:
	ba	.L91                ! sets=        uses=         deads=
	add	%g6,16,%g7          ! sets=%g7:    uses=%g6:     deads=
!
! block 6
! preds: 14
! succs: 7
...
! source statement 17
	...
	mov	%g7,%o1             ! sets=%o1:    uses=%g7:     deads=
!
! block 7
! preds: 6
! succs: 8 13
