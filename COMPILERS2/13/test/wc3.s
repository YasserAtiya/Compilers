...
! source statement 19
	...
	st	%o0,[%l0 + %lo(wd)] ! sets=        uses=%o0:%l0: deads=%o0:
...
! source statement 31
	...
	sethi	%hi(.L128),%i4      ! sets=%i4:    uses=         deads=
	sethi	%hi(.L112),%i5      ! sets=%i5:    uses=         deads=
!
! block 17
! preds: 16 48
! succs: 18 22
!  doms: 1 2 16 17
!   ins=%l0:%l2:%l4:%l5:%i4:%i5:
!  outs=%l0:%l2:%l4:%l5:%i4:%i5:
!
.L111:
! source statement 33
...
! source statement 40
	add	0,0,%l1             ! sets=%l1:    uses=         deads=
	sethi	%hi(wordct),%l6     ! sets=%l6:    uses=         deads=
	sethi	%hi(linect),%l7     ! sets=%l7:    uses=         deads=
	mov	%l1,%i0             ! sets=%i0:    uses=%l1:     deads=
	add	%l2,4,%i1           ! sets=%i1:    uses=%l2:     deads=
	mov	%o0,%i2             ! sets=%i2:    uses=%o0:     deads=
	mov	%o0,%i3             ! sets=%i3:    uses=%o0:     deads=%o0:
...
!
.L118:
	ld	[%i1],%o1           ! sets=%o1:    uses=%i1:     deads=
	add	%o1,1,%o2           ! sets=%o2:    uses=%o1:     deads=
	st	%o2,[%i1]           ! sets=        uses=%o2:%i1: deads=%o2:
...
.L120:
! source statement 45
	ld	[%i2 + %lo(charct)],%o0! sets=%o0:    uses=%i2:     deads=
	add	%o0,1,%o0           ! sets=%o0:    uses=%o0:     deads=%o0:
	st	%o0,[%i3 + %lo(charct)]! sets=        uses=%o0:%i3: deads=%o0:
! source statement 46
...
! source statement 54
	...
	add	%o0,1,%o0           ! sets=%o0:    uses=%o0:     deads=%o0:
	st	%o0,[%l7 + %lo(linect)]! sets=        uses=%o0:%l7: deads=%o0:
...
! source statement 63
	...
	add	%i4,%lo(.L128),%o0  ! sets=%o0:    uses=%i4:     deads=
	ld	[%l5 + %o2],%o1     ! sets=%o1:    uses=%o2:%l5: deads=%o2:
...
! source statement 101
	...
	mov	%i0,%o1             ! sets=%o1:    uses=%i0:     deads=%i0:
	call	printf,2            ! sets=scratch uses=%o0:%o1: deads=%o0:%o1:
	nop
!
! block 2
